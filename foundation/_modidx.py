...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'foundation.core': { 'foundation.core.A': ('core.html#a', 'foundation/core.py'),
            ...
            'foundation.diffusion': { 'foundation.diffusion.BasicUNet': ('diffusion.html#basicunet', 'foundation/diffusion.py'),
                                      'foundation.diffusion.BasicUNet.__init__': ( 'diffusion.html#basicunet.__init__',
                                                                                   'foundation/diffusion.py'),
                                      'foundation.diffusion.BasicUNet.forward': ( 'diffusion.html#basicunet.forward',
                                                                                  'foundation/diffusion.py'),
                                      'foundation.diffusion.corrupt': ('diffusion.html#corrupt', 'foundation/diffusion.py')},
            'foundation.transformer.all': { 'foundation.transformer.all.Transformer': ( 'transformer/transformer.html#transformer',
                                            ...
                                            'foundation.transformer.all.Transformer.__init__': ( 'transformer/transformer.html#transformer.__init__',
                                                                                                 'foundation/transformer/all.py'),
                                            'foundation.transformer.all.Transformer.create_src_mask': ( 'transformer/transformer.html#transformer.create_src_mask',
                                                                                                        'foundation/transformer/all.py'),
                                            'foundation.transformer.all.Transformer.create_trg_mask': ( 'transformer/transformer.html#transformer.create_trg_mask',
                                                                                                        'foundation/transformer/all.py'),
                                            'foundation.transformer.all.Transformer.forward': ( 'transformer/transformer.html#transformer.forward',
                                                                                                'foundation/transformer/all.py')},
            ...
            'foundation.transformer.efficient_attention': { 'foundation.transformer.efficient_attention.MultiHeadAttention': ( 'transformer/transformer.efficient_attention.html#multiheadattention',
                                                            ...
                                                            'foundation.transformer.efficient_attention.ScaleDotProductAttention.forward': ( 'transformer/transformer.efficient_attention.html#scaledotproductattention.forward',
                                                                                                                                             'foundation/transformer/efficient_attention.py')},
            'foundation.transformer.embedding': { 'foundation.transformer.embedding.TextEmbedding': ( 'transformer/transformer.embedding.html#textembedding',
            ...
            'foundation.transformer.encoder': { 'foundation.transformer.encoder.Encoder': ( 'transformer/transformer.encoder.html#encoder',
                                                ...
                                                'foundation.transformer.encoder.ResidualLayerNorm.forward': ( 'transformer/transformer.encoder.html#residuallayernorm.forward',
                                                                                                              'foundation/transformer/encoder.py')},
            'foundation.transformer.positional_encoding': { 'foundation.transformer.positional_encoding.PositionalEncoding': ( 'transformer/transformer.positional_encoding.html#positionalencoding',
                                                                                                                               'foundation/transformer/positional_encoding.py'),
                                                            'foundation.transformer.positional_encoding.PositionalEncoding.__init__': ( 'transformer/transformer.positional_encoding.html#positionalencoding.__init__',
                                                                                                                                        'foundation/transformer/positional_encoding.py'),
                                                            'foundation.transformer.positional_encoding.PositionalEncoding.forward': ( 'transformer/transformer.positional_encoding.html#positionalencoding.forward',
                                                                                                                                       'foundation/transformer/positional_encoding.py')},
            'foundation.transformer.train': {},
            ...
            'foundation.utils': {'foundation.utils.show_img': ('utils.html#show_img', 'foundation/utils.py')}}}
